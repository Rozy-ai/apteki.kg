...
namespace app\modules\yii2images\behaviors;

use app\modules\yii2images\models\Image;

use yii;
use yii\base\Behavior;
use yii\db\ActiveRecord;
use app\modules\yii2images\models;
...
class ImageBehave extends Behavior
{
     ...
     * @throws \Exception
     */
    public function attachImage($absolutePath, $sort = 0, $name = '')
    {
        ...
        if($sort == 0) {
            ...
            $imageQuery->orderBy(['sorted' => SORT_ASC, 'id' => SORT_ASC]);
