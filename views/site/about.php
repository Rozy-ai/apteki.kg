...
<div class="feedback">
    ...
    <div class="row">
      <div class="col-12 col-sm-7">
        <h1>О сервисе</h1>
        <p>«Аптеки в Бишкеке — www.apteki.kg» успешно работает с 2006 года на основе ежедневно обновляемых прайс-листов, предоставляемых аптеками-участниками.<br/>Сервис доступен пользователям в виде сайта и мобильных приложений, позволяя быстро находить лекарственные препараты и другие аптечные товары. </p>
        <p>Apteki.kg не аффилирован ни с одним из участников рынка аптечных товаров, что позволяет предоставлять пользователям сервиса актуальную и объективную информацию. Аптеки и аптечные сети, подключенные к сервису, размещают полный перечень имеющихся в наличии товаров. </p>
